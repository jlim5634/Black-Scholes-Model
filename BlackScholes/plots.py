...
class Plots:
    ...
    def generate_price_grid(self, bs_model, spot_range, vol_range):
        ...
        for i, vol in enumerate(vol_range):
            for j, spot in enumerate(spot_range):
                bs_temp = BlackScholes(time_to_maturity=bs_model.time_to_maturity, strike=bs_model.strike, current_price=spot, volatility = vol, interest_rate=bs_model.interest_rate)
    ...
    def plot_put_heatmap(sef, put_prices, spot_range, vol_range):
        fig, ax = plt.subplots(figsize=(10,8))
